...
<body>
 ...
 <div id="main" class="container-fluid">
  ...
  <h3 class="page-header">Editar Ministério</h3>
 <?php
 ...
 ?>
  <form action="proc_edita_ministerio.php" method="POST">
  	<div class="row">
	  <input type="hidden" value="<?php echo $ministerio["ID_MINISTERIO"];?>" name="id_ministerio" id="id_ministerio" >
  	  <div class="form-group col-md-2">
  	  	<label for="exampleInputEmail1">*Ministério:</label>
  	  	<input type="input" class="form-control" value="<?php echo $ministerio["NOME_MINISTERIO"];?>" name="nome_ministerio" id="nome_ministerio" placeholder="Digite o Ministério" required>
  	  </div>
	</div>
	<div class="row">
		<div class="form-group col-md-3">
		 <label for="exampleFormControlTextarea1" class="form-label">Descrição:</label>
		 <textarea class="form-control" name="descricao_ministerio" id="descricao_ministerio" rows="5" ><?php echo $ministerio["DESCRICAO_MINISTERIO"];?></textarea>
	    </div>		
	</div>
	<div class="row">
		<div class="form-group col-md-3">
